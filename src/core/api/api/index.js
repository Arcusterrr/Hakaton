...
function add_category(token, tit, mci) {
  return __awaiter(this, void 0, void 0, function*() {
    const cat = yield db_1.dbProdInfo.any(mySql.sql_addcategory, [
      token,
      tit,
      mci
    ]);
...
function add_main_category(token, tit) {
  return __awaiter(this, void 0, void 0, function*() {
    const amc = yield db_1.dbProdInfo.any(mySql.sql_addmaincategory, [
      token,
      tit
    ]);
    return amc;
...
function addcategorytoproduct(token, cid, pid) {
  return __awaiter(this, void 0, void 0, function*() {
    const addcat = yield db_1.dbProdInfo.any(
      mySql.sql_add_category_to_product,
      [token, cid, pid]
    );
    return addcat;
  });
